...
$manifest = parse_ini_file('manifest.ini', true);
...
svn_export_group($manifest['server_core'], $manifest['global'], $base_dir);
$server_onprem_all = $manifest['server_onprem'];
$server_onprem_all['svn_path'] = $server_onprem_all['svn_path'] . 'all/';
svn_export_group($server_onprem_all, $manifest['global'], $base_dir);
...
svn_export_group($server_onprem_specific, $manifest['global'], $base_dir);
svn_export_group($manifest['flash'], $manifest['global'], $base_dir);
svn_export_group($manifest['uiconf'], $manifest['global'], $base_dir);
svn_export_group($manifest['dwh'], $manifest['global'], $base_dir);
svn_export_group($manifest['installer'], $manifest['global'], $base_dir);
...
// TODO: Secret replacement for pre-made vm
